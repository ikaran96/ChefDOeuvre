...
<h2 class="add-title">Ajouter une formation diplômante</h2>
<x-message/>
<div class="form-wrapper">
    <form style="margin-left:auto;margin-right:auto" method="post" action="{{route('diplomantes.store')}}">
        @csrf
        <div class="form-group row">
            <label for="name" class="col-sm-2 col-form-label">Ecole *</label>
            <div class="col-sm-10">
